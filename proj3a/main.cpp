...
void findMatches(ifstream& myWordFile, string myGridFile)
{
    ...
    myDict.sortWords();
    // // TEMP IMPORT PRE-SORTED DICT
    //ifstream fin;
    //fin.open("sorted_dict.txt");
    //myDict.readDictionary(fin);
